...
export const Tip = ({text, warning = false}) => {
    if (text != null) {
        if (warning) {
            return (
                <View style={{height: 20, justifyContent: "flex-end", alignItems: "center", marginRight: 10, flexDirection: "row"}}>
        ...
        return (
            <View style={{height: 20, justifyContent: "flex-end", alignItems: "flex-end", marginRight: 10}}>
